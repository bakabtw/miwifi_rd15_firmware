...
ps_pre_stop_service() {
    ...
    [ "whc_cap" = "$NET_MODE" ] && list_contains LIST_SERVICES wan && ps_wandt_ctl filter load
...
ps_setup_wan() {
    ...
    # config wan network
    arch_ps_setup_wan "$service" "$wan_port" "$proto"
